...
$json_nobedadeak = file_get_contents("http://localhost/denda/api/produktuak/?mota=nobedadeak");
$nobedadeak = [];
...
$json_eskaintzak = file_get_contents("http://localhost/denda/api/produktuak/?mota=eskaintzak");
$eskaintzak = [];
